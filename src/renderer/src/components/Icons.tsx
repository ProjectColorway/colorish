...
import { classes } from "@renderer/api/Parsers";
...
export function HomeIcon(props: IconProps) {
    return <Icon
        {...props}
        className={classes(props.className, "dc-home-icon")}
        viewBox="0 0 24 24"
        strokeWidth={1.5}
        stroke="currentColor"
    >
...
export function StoreIcon(props: IconProps) {
    return <Icon
        {...props}
        className={classes(props.className, "dc-store-icon")}
        viewBox="0 0 24 24"
        strokeWidth={1.5}
        stroke="currentColor"
    >
...
export function CogIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            viewBox="0 0 24 24"
            className={classes(props.className, "dc-cog-icon content-visible")}
            strokeWidth={1.5}
            stroke="currentColor"
        >
