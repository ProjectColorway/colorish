...
export default function ({ placeholder = "", children = <></>, style = {} }: { value?: string, onInput?: (value: string) => void, placeholder?: string, children?: React.ReactNode, disabled?: boolean, readOnly?: boolean, style?: React.CSSProperties, page?: { placeholder: string, index: number; }; }) {
